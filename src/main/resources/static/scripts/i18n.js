const messages = {
  de: {
    ...
    general: {
      ...
      monat: 'Monat',
      name: 'Name',
      nameAnschrift: 'Name und Anschrift',
      ...
      stornobeleg: 'Stornierungsbeleg zu Rechnungsnummer',
      strasse: 'Straße',
      suchen: 'Suchen',
    ...
    kunde: {
      ...
      nachname: 'Nachname',
      problem: 'Problematischer Kunde',
      problemInfo: 'Beim Auswählen des Kunden erscheint eine Meldung mit dem in der Bemerkung hinterlegten Text',
      problemStandard: 'Der gewählte Kunde wurde als problematisch eingestuft',
      suchen: 'Kunde suchen',
    ...
    rechnung: {
      ...
      postenNichtStornieren: 'Diesen Posten nicht stornieren',
      postenStornieren: 'Diesen Posten stornieren',
      ...
      zahlungsartBarZusatz2: 'Betrag in Bar erhalten',
