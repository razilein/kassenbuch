...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        .authorizeRequests()
            ...
            .antMatchers(HttpMethod.PUT, "/auftrag").hasRole("AUFTRAG_VERWALTEN")
            .antMatchers(HttpMethod.DELETE, "/auftrag").hasRole("AUFTRAG_VERWALTEN")
            .antMatchers("/auftrag-drucken.html*").hasRole("AUFTRAG")
            .antMatchers("/auftrag.html*").hasRole("ZUGRIFF_AUFTRAG_ERSTELLEN")
            .antMatchers("/auftrag-uebersicht.html?id=*").hasRole("KUNDEN_AUFTRAG")
            .antMatchers("/auftrag-uebersicht.html*", "/auftrag*").hasRole("ZUGRIFF_AUFTRAG_UEBERSICHT")
